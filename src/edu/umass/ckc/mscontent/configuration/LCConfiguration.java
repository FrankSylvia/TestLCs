package edu.umass.ckc.mscontent.configuration;
 ...
 */
@Configuration
public class LCConfiguration implements ServletContextAware {

    private ServletContext servletContext;
    private DataSource dataSource;
    private static Logger logger =   Logger.getLogger(LCConfiguration.class);
